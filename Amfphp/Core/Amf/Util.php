...
class Amfphp_Core_Amf_Util
{
     ...
     */
    public static function applyFunctionToContainedObjects($obj, $callBack, $recursionDepth = 0, $maxRecursionDepth = 30, $ignoreAmfTypes = true)
    {
     ...
     * @return bool
     */
    public static function is_byteArray($obj)
    {
     ...
     * @return bool
     */
    public static function is_date($obj)
    {
     ...
     * @return bool
     */
    public static function is_Xml($obj)
    {
     ...
     * @return bool
     */
    public static function is_XmlDocument($obj)
    {
