...
require_once dirname(__FILE__) . '/../../../Amfphp/plugins/AMFPHPCharsetConverter.php';
...
class AMFPHPCharsetConverterTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        $this->object = new AMFPHPCharsetConverter;
        $this->object->clientCharset = "UTF-8";
        $this->object->phpCharset = "ISO-8859-1";
        $this->object->method = AMFPHPCharsetConverter::METHOD_ICONV;
